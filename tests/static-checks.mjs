...
assert.match(app, /data-testid="toggle-dark-mode"/);
assert.doesNotMatch(app, /className="theme-toggle"/);
assert.doesNotMatch(app, /SimpleMindmap|OutlineView|NodeDetailsDialog|mindmap-operations|custom search/i);
assert.match(database, /__WHITEBOARD_DATABASE_NAME__/);
assert.match(vite, /WHITEBOARD_DATABASE_NAME.*offline-whiteboard-v1/);
