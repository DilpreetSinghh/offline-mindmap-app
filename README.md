...
- **Shape recognition** turns completed freehand strokes that clearly resemble a circle, ellipse, rectangle, diamond, triangle, straight line or arrow into perfect shapes with the original stroke styling. It is enabled by default and can be toggled from the main menu; the preference is stored in browser storage.
